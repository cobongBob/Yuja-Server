...
public class UserServiceImpl implements UserService {
   ...
   public UserResponseDto findById(Long id, Long attemptingUser) {
      ...
      if(!id.equals(attemptingUser) && (!attempting.getAuthorities().contains(authoritiesRepository.findByAuthority(AuthorityNames.ADMIN).get()) && !attempting.getAuthorities().contains(authoritiesRepository.findByAuthority(AuthorityNames.MANAGER).get()))) {
   ...
   public String delete(Long bno, Long userId) {
      ...
      if(bno.equals(userId) || isAdminOrManager) {
